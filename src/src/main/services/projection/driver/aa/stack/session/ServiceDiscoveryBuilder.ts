...
import { TYPING_KEYCODES } from '@shared/types/KeyboardInput'
import {
  BT_PAIRING_METHOD,
  CH,
  DISPLAY_TYPE,
...
export function buildServiceDiscoveryResponse(
  ...
  channels.push({
    id: CH.INPUT,
    inputSourceService: {
      // Command keycodes, plus the printable set a physical keyboard types with:
      // a keycode that is not advertised here is dropped by the phone. See
      // shared/types/KeyboardInput.ts.
      keycodesSupported: [
